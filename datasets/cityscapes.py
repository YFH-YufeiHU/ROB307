...
class Cityscapes(data.Dataset):
    ...
    **Parameters:**
    ...
    def __init__(self, root, split='train', mode='fine', target_type='semantic', transform=None):
        ...
        self.split = split
        self.images = recursive_glob(rootdir=self.root,suffix=".jpeg")
        self.targets = []
...
if __name__ == '__main__':
    ...
    data = Cityscapes(root='/home/yufei/Documents/GitHub/ROB307_segmentatation/data',transform=transforms.ToTensor())
